...
- The eventual **homepage swap** (make `/crt3d` the front door, move `index.html` to `/site`) — one step away now that the boot transition exists; do it when the look is locked.
